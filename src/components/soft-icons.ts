...
export { PlayCircleIcon as PlayCircle } from 'phosphor-react-native/src/icons/PlayCircle';
export { PauseCircleIcon as PauseCircle } from 'phosphor-react-native/src/icons/PauseCircle';
